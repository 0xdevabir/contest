...
const navigation: NavGroup[] = [
  {
    ...
    items: [
      ...
      { href: "/admin/problems", label: "Problems", icon: BookOpen, exact: true },
      { href: "/admin/problems/review", label: "Review queue", icon: ClipboardCheck },
      { href: "/admin/submissions", label: "Submissions", icon: Braces },
      { href: "/admin/rejudge", label: "Rejudge", icon: RotateCcw },
    ],
  },
  {
    heading: "People",
